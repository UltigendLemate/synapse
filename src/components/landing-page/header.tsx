  ...
  return (
    <header className='p-4 flex items-center justify-center'>
              ...
              <ul className='grid gap-3 p-6 md:w-[400px]  lg:grid-cols-[.75fr_1fr]'>
                <li className='row-span-3'>
                  <span className='flex h-full w-full select-none 
                    flex-col justify-end rounded-md bg-gradient-to-b
      ...
      <aside className='flex w-full justify-end gap-2'>
        <Link href={"/login"} ><Button variant="btn-secondary" className='p-1 hidden sm:block'>Login</Button></Link>
        <Link href={"/signup"} ><Button variant="btn-primary" className='whitespace-nowrap'>Sign Up</Button></Link>
