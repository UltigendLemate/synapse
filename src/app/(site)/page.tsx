    ...
    return (
        <>
            ...
            before:content[''] before:dark:from-brand-dark before:to-transparent before:from-background before:bg-gradient-to-r before:left-0 before:bottom-0 before:top-0 before:w-20 before:z-10 before:absolute" >
                    ...
                    {[...Array(2)].map((arr) => <div className='flex flex-nowrap animate-slide' key={arr}>
                        {CLIENTS.map((client) => (
                            <div className='relative w-[200px] m-20 shrink-0 flex items-center' key={client.alt}>

                                <Image src={client.logo} className='object-contain max-w-none' alt={client.alt} width={200} height={50} />
            ...
            <section className='px-4 sm:px-6 flex justify-center items-center flex-col relative'>
                ...
                <TitleSection title='Keep track of your meetings all in one place' subheading='Capture your ideas, and meeting notes in a structured and organized manner' pill='Features' />
                <div className='max-w-[450px] mt-10 rounded-2xl border-8 border-washed-blue-300 border-opacity-10 flex justify-center items-center relative sm:ml-0'>
                    <Image
                        src={Calendar}
                        alt="Banner"
            ...
            personal and professional productivity needs."
                    ...
                    {[...Array(2)].map((arr, index) => <div key={randomUUID()} className={twMerge(
                        ...
                        {USERS.map((testimonial, index) => (
                            <CustomCard key={index} className='w-[500px] shrink-0 rounded-xl dark:bg-gradient-to-t dark:from-border dark:to-background'
                                cardHeader={
